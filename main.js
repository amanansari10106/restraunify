function webCreatorCheck(res){
    console.log(res);
    if (!res.success){
        // location.replace("https://vqcoaching.vq.pe"+"/creator/dashboard");
    }
}
...
if  (window.location.href.indexOf("/edit.html") > -1) {
    ...
    rawAjax(data);
    $.getScript("https://vqcoaching.vq.pe"+"/creator/admin/js/icons.js"); 
    $.getScript("https://vqcoaching.vq.pe"+"/creator/admin/js/upload_image.js");  
    $.getScript("https://vqcoaching.vq.pe"+"/creator/admin/js/editor.js");       
}
